...
| UTHP-R1-0065 | PASS | hardware,core,plc,remote,can0-2 | SB | all tests passed! |
| UTHP-R1-0009 | PASS | hardware,core,plc,remote,can0-2 | SB | all tests passed! (no safe-shutdown)|
| UTHP-R1-0042 | PASS | hardware,core,plc,remote,can0-2 | SB | all tests passed! |
